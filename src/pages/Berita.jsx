...
const Berita = () => {
  ...
  const handleLihat = (berita) => {
    Swal.fire({
      title: `<h3 style="font-size: 1.2rem;">${berita.judul}</h3>`,
      html: `
      <img src="${berita.image_url}" alt="gambar" style="max-width: 100%; items-center width: 300px; border-radius: 8px; margin-bottom: 10px;" />
      <p style="font-size: 0.9rem; line-height: 1.4;">${berita.teks}</p>
      <hr style="margin: 10px 0;" />
      <p style="font-size: 0.75rem; color: gray;">Dibuat oleh: ${berita.created_by}</p>
    `,
      width: 400,
  ...
  return (
    <div className="min-h-screen from-slate-50 via-white to-slate-100 p-3 sm:p-4">
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-3 py-2 w-full sm:w-56 bg-white border border-slate-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-sm"
                />
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-medium text-sm"
              >
        ...
        {/* Content Section - Border Radius Dikurangi */}
        <div className="bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden">
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="flex flex-col items-center gap-3">
                <div className="w-6 h-6 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
                <p className="text-slate-600 text-sm">Memuat berita...</p>
              </div>
            </div>
          ) : (
            <>
              {/* Table Header - Padding Dikurangi */}
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {paginatedData.map((berita, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="text-slate-600 line-clamp-2 max-w-sm text-xs">
                            {berita.teks}
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center">
                            <div className="w-20 h-12 rounded-lg overflow-hidden shadow-md bg-slate-100 flex items-center justify-center">
                              <img
