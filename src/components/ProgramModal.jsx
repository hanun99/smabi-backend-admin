...
import { X, Upload, Image, FileText, Type, Eye, Target } from "lucide-react";
import supabase from "../utils/SupaClient";
import Swal from "sweetalert2";

const ProgramModal = ({ onClose, onSave, isEdit, initialData }) => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  {isEdit
                    ? "Perbarui informasi program unggulan"
                    : "Buat program unggulan baru"}
                </p>
              </div>
            </div>
            <button
